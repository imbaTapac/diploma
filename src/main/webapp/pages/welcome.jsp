        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="pull-right">
                    <div class="lang">
                        <ul>
                            <li><a href="?lang=en"><img src="${contextPath}/pages/img/united-kingdom_l.png" width="25"
                                                        height="15"></a></li>
                            <li><a href="?lang=ru"><img src="${contextPath}/pages/img/russia_l.png" width="25" height="15"></a>
                            </li>
                            <li><a href="?lang=uk"><img src="${contextPath}/pages/img/ukraine_l.png" width="25" height="15"></a>
                            </li>
                        </ul>
                    </div>
                </div>
