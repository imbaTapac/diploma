...
import student_rating.config.Initializer;
import student_rating.entity.*;
...
public class EntityTests {
    ...
    public void before() {
        ...
        .addAnnotatedClass(Faculty.class).addAnnotatedClass(Specialty.class).addAnnotatedClass(OKR.class).addAnnotatedClass(Roles.class);
