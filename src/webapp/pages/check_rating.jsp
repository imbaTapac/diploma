...
<head>
    ...
    <script src="/pages/js/rating.js"></script>
</head>
<body>
<div class="wrapper">
<div class="container">
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="row">
            ...
            <table id="myTable" class="main-table" border="10">
                <tr>
                    <th colspan="5">Студенти які потребують перевірки</th>
                </tr>
                ...
                <tr><td class="column"><c:out value="${counter}"></c:out></td><td><c:out value="${students.studentSurname}"></c:out></td><td><c:out value="${students.studentName}"></c:out><td><c:out value="${students.phone}"></c:out></td><td><button class="btn btn-info btn-sm check-btn" name="id" value="${students.id}">Перевірити рейтинг</button></td>
                ...
                <c:when test="${students.size() == 0}">
                    <h2 align="center">Ще немає студентів вашої групи, які заповнили рейтинг</h2>
                </c:when>
            </c:choose>
        </div>
